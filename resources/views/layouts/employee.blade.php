        ...
        >
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <a href="{{ route('employee-dashboard') }}" 
                   ...
                   class="group flex items-center px-4 py-3 rounded-lg transition-all duration-300 ease-in-out {{ request()->routeIs('employee-dashboard') ? 'bg-teal-600 text-white' : 'text-teal-100 hover:bg-teal-600 hover:text-white' }}">
                ...
                <a href="{{ route('employee.attendance') }}" 
                   @click="sidebarOpen = false"
                   :title="sidebarCollapsed ? 'My Attendance' : ''"
                   class="group flex items-center px-4 py-3 rounded-lg transition-all duration-300 ease-in-out {{ request()->routeIs('employee.attendance') ? 'bg-teal-600 text-white' : 'text-teal-100 hover:bg-teal-600 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 transition-all duration-300 ease-in-out group-hover:scale-110" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('employee.request-leave') }}" 
                   @click="sidebarOpen = false"
                   :title="sidebarCollapsed ? 'Request Leave' : ''"
                   class="group flex items-center px-4 py-3 rounded-lg transition-all duration-300 ease-in-out {{ request()->routeIs('employee.request-leave') ? 'bg-teal-600 text-white' : 'text-teal-100 hover:bg-teal-600 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 transition-all duration-300 ease-in-out group-hover:scale-110" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('employee.profile') }}" 
                   ...
                   class="group flex items-center px-4 py-3 rounded-lg transition-all duration-300 ease-in-out {{ request()->routeIs('employee.profile') ? 'bg-teal-600 text-white' : 'text-teal-100 hover:bg-teal-600 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 transition-all duration-300 ease-in-out group-hover:scale-110" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('employee.change-password') }}" 
                   @click="sidebarOpen = false"
                   :title="sidebarCollapsed ? 'Change Password' : ''"
                   class="group flex items-center px-4 py-3 rounded-lg transition-all duration-300 ease-in-out {{ request()->routeIs('employee.change-password') ? 'bg-teal-600 text-white' : 'text-teal-100 hover:bg-teal-600 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 transition-all duration-300 ease-in-out group-hover:scale-110" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-teal-600">
                <div class="flex items-center mb-3" :class="sidebarCollapsed ? 'justify-center' : 'px-4'">
                    ...
                    >
                        ...
                        <p class="text-xs text-teal-200">Employee</p>
                    </div>
                </div>
